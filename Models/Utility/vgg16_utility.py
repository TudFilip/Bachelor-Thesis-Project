...
SAVED_MODEL_PATH = GeneralUtils.SAVED_MODELS_PATH + 'VGG16_1/'
...
def load_images_and_labels(img_path, img_label):
    """Load and preprocess images and labels in the training dataset"""
...
def create_checkpoint_latest():
    ...
    filepath = SAVED_MODEL_PATH + 'vgg16_1_latest_10movies.hdf5'
...
def create_checkpoint(date, time):
    ...
    filename = 'vgg16_1_10movies_' + str(date) + '_' + str(time) + '.hdf5'
