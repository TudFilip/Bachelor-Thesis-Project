...
SAVED_MODEL_PATH = GeneralUtils.SAVED_MODELS_PATH + 'ResNet50/'
...
def create_checkpoint_latest():
    ...
    filepath = SAVED_MODEL_PATH + 'resnet50_latest_10movies.hdf5'
...
def create_checkpoint(date, time):
    ...
    filename = 'resnet50_10movies_' + str(date) + '_' + str(time) + '.hdf5'
